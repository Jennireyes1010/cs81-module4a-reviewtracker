...
// Its purpose is to manage and add reading entries, it declares the structure for the program and uses const because the reading log itself does not change reference, only its contents do.
